// Cloudflare Pages Functions entry point — same shared-handler pattern as explain/summarize/combine.
import { pickHighlights } from "../../../src/aiHandlers.js";
...
export async function onRequestPost({ request, env }) {
  ...
  try {
    const text = await pickHighlights(env, await request.json());
